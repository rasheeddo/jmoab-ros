...
from std_msgs.msg import Float32MultiArray, Int32MultiArray, UInt8, Bool
...
class Imu2Compass(object):
	...
	def __init__(self, NS):
		...
		rospy.Subscriber(self.namespace_attaching(NS, "/jmoab/cart_mode"), UInt8, self.cart_mode_callback)
